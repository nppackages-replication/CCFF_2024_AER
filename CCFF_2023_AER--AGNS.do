...
save $main/data/temp/tmp_CCFF_2023_AGNS, replace
...
append using $main/data/temp/tmp_CCFF_2023_AGNS
...
********************************************************************************
use $main/CCFF_2023_AGNS, clear

binsreg lnpat mtr90_lag3, nbins(10) xlabel(-0.9(0.3)0) plotxrange(-0.9,0) polyreg(1) dotsplotopt(mcolor(black)) polyregplotopt(lcolor(forest_green)) graphregion(color(white) margin(large)) plotregion(lcolor(black)) ylabel(4(2)8, nogrid) ytitle("Log Patents") xtitle("Combined Marginal Tax Rate for 90th Percentile") legend(on order(1 "Binscatter" 2 "Linear Fit") ring(0) pos(1) cols(1))
...
graph export "graphs/AGNS_covariateAdjustments.png", replace as(png) width(800) height(600)
...
tw (rarea CB_l CB_r CB_x, fcolor(edkblue) fintensity(20) lwidth(none)) (scatter dots_fit dots_x, mcolor(black)), graphregion(color(white) margin(large)) plotregion(lcolor(black)) ylabel(, nogrid nogextend) legend(off) ytitle("Log Patents") xtitle("Combined Marginal Tax Rate for 90th Percentile")
graph export "graphs/AGNS_confidenceBandwDots.pdf", replace
...
tw (rarea CB_l CB_r CB_x, fcolor(edkblue) fintensity(20) lwidth(none)) (line inline CB_x, lcolor(red)), graphregion(color(white) margin(large)) plotregion(lcolor(black)) ylabel(, nogrid nogextend) legend(off) ytitle("Log Patents") xtitle("Combined Marginal Tax Rate for 90th Percentile")
...
binsreg lnpat  mtr90_lag3 top_corp_lag3 lreal_gdp_pc lpopulation_density rd_credit_lag3 [aw=pop1940], randcut(1) at(median) polyreg(1) dotsplotopt(mcolor(black)) polyregplotopt(lcolor(forest_green)) graphregion(color(white) margin(large)) plotregion(lcolor(black)) ylabel(, nogrid nogextend) legend(off) ytitle("Log Patents") xtitle("Combined Marginal Tax Rate for 90th Percentile")
graph export "graphs/AGNS_wControls_atWmedian.pdf", replace
graph export "graphs/AGNS_wControls_atWmedian.png", replace as(png) width(800) height(600)
